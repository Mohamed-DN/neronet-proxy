...
//
// The full list, not the subset a node might register from. Geo-fencing policies
// name countries the fleet has no presence in — blocking a country you do not
// operate in is the usual case — so a partial table left those policies showing
// the code where a name belongs.
//
// An unknown code is displayed as the code itself, which is more useful than
// "Unknown" when a new or reassigned code appears.
const COUNTRY_NAMES = {
