> Historical document, not maintained. It is the design of an end-to-end test harness of an earlier phase. The suites it describes have been deleted, and it does not describe the current code. For the current state read [the handbook](../HANDBOOK.md).
